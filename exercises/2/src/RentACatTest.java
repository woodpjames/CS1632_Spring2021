...
public class RentACatTest {
	...
	public void setUp() throws Exception {
		...
		this.c1 = Mockito.mock(Cat.class);
		...
		this.c2 = Mockito.mock(Cat.class);
		...
		this.c3 = Mockito.mock(Cat.class);
	...
	public void testCatName() {
		assertEquals("Jennyanydots", c1.getName());
	}
	...
	public void testGetCatNumCats3() {
		...
		r.addCat(c3);
		Cat returnCat = r.getCat(2);
		assertNotNull("Value is null", returnCat);
		assertEquals(returnCat.getId(), 2);
	}
